...
| SC-071 | Dockerfile for Docker image | merged | 2026-03-14 | Multi-stage: golang:1.23-alpine → alpine:3.19 with git + ca-certs. Grammar pre-caching added: `grammar install` during build, cached at /usr/local/share/vettcode (FR-2 offline compliance). |
